...
VALUES
	...
	(212,0,'public/audio/toi_đen_tu_nhat_ban.wav','Tôi đến từ Nhật Bản','I come from Japan',8),
	...
	(261,0,'public/audio/rat_vui_đuợc_gap_ba.wav','Rất vui được gặp bà','Nice to meet you/ Glad to see you',11),
	...
	(300,0,'public/audio/anh_bao_nhiêu_tuoi.wav','Anh bao nhiêu tuổi?','How old are you?',14),
...
VALUES
	...
	(994,0,0,'Examples',200),
	(995,1,1,'*Chào* bạn\n*Hello/hi*',200),
	(996,0,0,'Examples',201),
	(997,1,1,'Chào *bạn*\nHello (to *you*)\n\nRất vui được gặp *bạn*\nNice to meet *you*',201),
	(998,0,0,'Examples',202),
	(999,1,1,'*Xin chào* mọi người \n*Hello* everyone',202),
	(1000,0,0,'Examples',203),
	(1001,1,1,'*Rất vui được gặp* bạn\n*Nice to meet* you',203),
	(1002,0,0,'Examples',204),
	(1003,1,1,'*Rất vui được làm quen với* bạn\nIt\'s *glad to know* you',204),
	(1004,0,0,'Examples',205),
	(1005,1,1,'*Tạm biệt* bạn\n*Goodbye*',205),
	(1006,0,0,'Examples',206),
	(1007,1,1,'*Tên tôi là* David\n*My name is* David',206),
	(1008,1,0,'Synonym: *gì*',207),
	(1009,0,1,'Examples',207),
	(1010,1,2,'*What* is your name?\nBạn tên *gì*?',207),
	(1011,0,0,'Examples',209),
	(1012,1,1,'*Xin lỗi*, bạn tên gì?\n*Excuse me*, what is your name? \n\n*Xin lỗi*, tôi bận rồi\n*Sorry*, I\'m busy ',209),
	(1013,1,0,'Introduce your nationality:\n*Tôi là người* + nationality',211),
	(1014,0,1,'Examples',211),
	(1015,1,2,'*Tôi là người* Anh\nI am British',211),
	(1016,1,0,'Introduce your country:\n*Tôi đến từ* + country',212),
	(1017,0,1,'Examples',212),
	(1018,1,2,'*Tôi đến từ* Hoa Kỳ\n*I come from* the USA',212),
	(1019,1,0,'Change into *mốt* when it follows *mươi*',214),
	(1020,0,1,'Examples',214),
	(1021,1,2,'Tôi có *một* con mèo\nI have *one* cat \n\nTôi có hai *mươi mốt* con mèo\nI have twenty *one* cat ',214),
	(1022,0,0,'Examples',215),
	(1023,1,1,'Tôi có *hai* con chó\nI have *two* dogs',215),
	(1024,0,0,'Examples',216),
	(1025,1,1,'Tôi có *ba* cái xe \nI have *three* cars',216),
	(1026,1,0,'Can be changed into *tư* when it follows *mươi*',217),
	(1027,0,1,'Examples',217),
	(1028,1,2,'Tôi có *bốn* con cá \nI have *four* fishes\n\nTôi có ba mươi *bốn* con cá/ Tôi có ba *mươi tư* con cá \nI have thirty *four* fishes',217),
	(1029,1,0,'Change to *lăm* when counting by tens',218),
	(1030,0,1,'Examples',218),
	(1031,1,2,'Tôi có *năm* cái xe \nI have *five* cars\n\nTôi có mười *lăm* cái xe\nI have *fifteen* cars ',218),
	(1032,1,0,'Change to *mươi* when it\'s followed by a number ',223),
	(1033,0,1,'Examples',223),
	(1034,1,2,'Tôi có *mười* cây bút\nI have *ten* pens\n\nTôi có hai *mươi* cây bút \nI have *twenty* pens',223),
	(1035,0,0,'Examples',228),
	(1036,1,1,'Tôi có năm *trăm* năm \nI have five *hundred* years',228),
	(1037,0,0,'Examples',229),
	(1038,1,1,'Tôi có ba *nghìn* đồng\n I have three *thousand* dong',229),
	(1039,0,0,'Examples',230),
	(1040,1,1,'Tôi có một *triệu* đồng \n I have one *million* dong ',230),
	(1041,0,0,'Examples',231),
	(1042,1,1,'Tôi có 2 *tỷ* đô\nI have two *billion* dollar',231),
	(1043,1,0,'*rưỡi* can be used as a short for *half* when it comes to hundred and more',232),
	(1044,0,1,'Examples',232),
	(1045,1,2,'Tôi có hai trăm *rưỡi* đô \nI have two hundred fifty dollar (two hundred and *a half* of hundred)',232),
	(1046,1,0,'*linh* means zero, and is used when hundred goes with numbers that smaller than ten',233),
	(1047,0,1,'Examples',233),
	(1048,1,2,'Bốn trăm linh bốn chiếc tàu\nFour hundred and four ships',233),
	(1049,0,0,'Examples: ',238),
	(1050,1,1,'Tôi *thích* mèo \nI *like* cats',238),
	(1051,0,0,'Examples: ',239),
	(1052,1,1,'*màu* tôi ưa thích là hồng \nMy favorite *color* is pink ',239),
	(1053,0,0,'Examples: ',240),
	(1054,1,1,'Tôi thích màu đỏ \nI like red',240),
	(1055,1,0,'used when you\'re talking to a stranger or in daily conversations',251),
	(1056,0,1,'Examples:',251),
	(1057,1,2,'*Tôi* tên là Jim\n*I* am Jim\n\nJim is *me*\nJim là *tôi*',251),
	(1058,1,0,'used to show politeness and respect or closeness to an elder man',252),
	(1059,0,1,'Examples:',252),
	(1060,1,2,'Chào *ông*, tôi tên là Minh\nHi *sir*, my name is Minh\n\n*Ông* cụ trông vui vẻ \nThe *grandpa* seems happy',252),
	(1061,1,0,'*ấy* is used as *that* ',253),
	(1062,0,1,'Examples:',253),
	(1063,1,2,'Chú *ấy* đang buồn\n*That* man is sad',253),
	(1064,1,0,'used to show politeness and respect or closeness to an elder woman',254),
	(1065,0,1,'Examples:',254),
	(1066,1,2,'Chào *bà*, tôi tên là My \nHi *m\'am*, my name is My \n\n*Bà* cụ trông rất vui vẻ\nThe *grandma* seems happy ',254),
	(1067,1,0,'used to show politeness and respect or closeness to a middle-aged man or woman',255),
	(1068,0,1,'Examples:',255),
	(1069,1,2,'*Bác ấy* rất tốt bụng \nThat uncle/aunt is very nice ',255),
	(1070,1,0,'used to show politeness and respect or closeness a middle-aged man',256),
	(1071,0,1,'Examples:',256),
	(1072,1,2,'*Chú* ấy thích màu xanh lá\nThat *uncle/man* likes green',256),
	(1073,1,0,'used to show politeness and respect or closeness to a middle-aged woman',257),
	(1074,0,1,'Examples:',257),
	(1075,1,2,'*Cô* ấy thích màu đen \nThat *aunt/woman* likes black',257),
	(1076,1,0,'used in daily conversations with an older man or about your age',258),
	(1077,0,1,'Examples:',258),
	(1078,1,2,'*Anh* ấy cho tôi kẹo\nThat *brother/bro/man* gives me candy ',258),
	(1079,1,0,'used in daily conversations with an older woman or about your age',259),
	(1080,0,1,'Examples:',259),
	(1081,1,2,'*Chị* ấy xinh đẹp \nThat *sister/sis/woman* is beautiful ',259),
	(1082,1,0,'used in daily conversations with a person who is about your age',260),
	(1083,0,1,'Examples:',260),
	(1084,1,2,'*Em* ấy thích màu đỏ \n*He/She* likes red ',260),
	(1085,0,0,'Examples: ',261),
	(1086,1,1,'Xin chào, *rất vui được gặp bà* \nHi, *nice to meet you, m\'am*',261),
	(1087,0,0,'Examples: ',264),
	(1088,1,1,'Bạn *ở đâu*?\n*Where* are you?',264),
	(1089,0,0,'Examples: ',265),
	(1090,1,1,'Tôi *làm* bài tập\nI *do* my homework ',265),
	(1091,0,0,'Examples: ',266),
	(1092,1,1,'*Công việc* của bạn là gì?\nWhat is your *job*?',266),
	(1093,0,0,'Examples: ',267),
	(1094,1,1,'Where do you *work*? \nBạn *làm việc* ở đâu?',267),
	(1095,0,0,'Examples: ',268),
	(1096,1,1,'Tôi là *giáo viên*\nI am a *teacher*',268),
	(1097,0,0,'Examples: ',269),
	(1098,1,1,'Tôi là *bác sĩ*\nI am a *doctor ',269),
	(1099,0,0,'Examples: ',279),
	(1100,1,1,'Tôi *khỏe*, cảm ơn\nI am *good/well/fine*, thank you',279),
	(1101,0,0,'Examples: ',280),
	(1102,1,1,'*Cảm ơn* bạn\n*Thank* you',280),
	(1103,0,0,'Examples: ',281),
	(1104,1,1,'*Không*, tôi *không* khỏe \n*No*, I am *not* good',281),
	(1105,0,0,'Examples: ',282),
	(1106,1,1,'*Đây là* Jim\n*This is* Jim',282),
	(1107,0,0,'Examples: ',283),
	(1108,1,1,'Đây là *bạn của tôi*, Tim\nThis is *my friend*, Tim',283),
	(1109,0,0,'Examples: ',287),
	(1110,1,1,'*Tôi là* bác sĩ\n*I am* a doctor',287),
	(1111,0,0,'Examples: ',291),
	(1112,1,1,'Tôi hai mươi *tuổi*\nI am twenty *years old*\n\nBạn bao nhiêu *tuổi*?\nHow *old* are you?',291),
	(1113,0,0,'Examples: ',292),
	(1114,1,1,'*Sở thích* của tôi là ca hát\nMy *hobby* is singing',292),
	(1115,0,0,'Examples: ',293),
	(1116,1,1,'Tôi *thích* đọc sách\nI like *reading books*',293),
	(1117,0,0,'Examples: ',297),
	(1118,1,1,'Cái đó *bao nhiêu* tiền?\n*How much* money is it?',297),
	(1119,1,0,'(talking to an older man)',300),
	(1120,0,0,'Examples: ',303),
	(1121,1,1,'Tôi *cảm thấy* vui vẻ\nI *feel* happy',303),
	(1122,0,0,'Examples: ',304),
	(1123,1,1,'Tôi cảm thấy *mệt*\nI feel *tired*',304),
	(1124,0,0,'Examples: ',305),
	(1125,1,1,'Bạn đang cảm thấy *vui vẻ* không?\nDo you feel *happy*?',305),
	(1126,0,0,'Examples: ',315),
	(1127,1,1,'Tôi *muốn* ăn bánh\nI *want* to eat cakes',315),
	(1128,0,0,'Examples: ',316),
	(1129,1,1,'Tôi *ăn* cơm\nI *eat* rice',316),
	(1130,0,0,'Examples: ',317),
	(1131,1,1,'Tôi *uống* nước\nI *drink* water',317),
	(1132,0,0,'Examples: ',318),
	(1133,1,1,'Tôi thích ăn *cơm*\nI like to eat *rice*',318),
	(1134,0,0,'Examples: ',319),
	(1135,1,1,'Tôi thích uống *bia*\nI like to drink *beer* ',319);
...
VALUES
	...
	(8,'Greetings',1,1),
	(9,'Counting',1,1),
	(10,'Favorite colors',1,1),
	(11,'Personal Pronounce',1,1),
	(12,'Occupation',1,1),
	(13,'How are you',1,1),
	(14,'Age and hobby',1,1),
	(15,'How do I feel?',1,1),
	(16,'Eating and drinking',1,1);
